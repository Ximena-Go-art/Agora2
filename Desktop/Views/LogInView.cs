...
namespace Desktop.Views
{
    public partial class LogInView : Form
    {
        ...
        private async void BtnInicio_Click(object sender, EventArgs e)
        {
            try
            {
                UserCredential userCredential = await _firebaseAuthClient.SignInWithEmailAndPasswordAsync(TextBoxEmail.Text, TextBoxPassword.Text);
        ...
        {
            TextBoxPassword.PasswordChar = CheckContraseña.Checked ? '\0' : '*';
